        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ url('barang') }}" class="nav-item nav-link"><i class="fas fa-file"></i>Barang</a>
                </div>
                <div class="navbar-nav w-100">
                    <a href="{{ url('kasir') }}" class="nav-item nav-link"><i class="fas fa-user-graduate"></i>Kasir</a>
                </div>
                <div class="navbar-nav w-100">
                    <a href="{{ url('tenan') }}" class="nav-item nav-link"><i class="fas fa-layer-group"></i>Tenan</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
